...
BILLING_PAYMENT_POLL_INTERVAL_SECONDS = int(os.getenv('BILLING_PAYMENT_POLL_INTERVAL_SECONDS', '5'))
BILLING_PAYMENT_POLL_TIMEOUT_SECONDS = int(os.getenv('BILLING_PAYMENT_POLL_TIMEOUT_SECONDS', '60'))
